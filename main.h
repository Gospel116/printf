...
/**
 * typedef struct fmt fmt_t - This program performs a Struct op ability
 *
 * @fmt: The format tht will be used.
 * @fm_t: The function that is associated with the program.
 */
